...
public class HealthPotion extends Potion {
	 ...
	 */
	public HealthPotion(String name, int usages, int price, int weight, int health) {  //TC
		super(name, usages, price, weight);
		if ( health < 0 ) {
			throw new IllegalArgumentException("health can not be negativ.");
		}
		this.health = health;
	}
	 ...
	 */
	@Override
	public String additionalOutputString() {  //TC
		String res = "; +" + this.health + " HP";
		return res;
	}
