...
public abstract class Spell {
	...
	public Spell(String name, int manaCost, MagicLevel levelNeeded) {
		...
		this.name = name;
		if ( manaCost < 0 ) {
			throw new IllegalArgumentException("manaCost can not be negativ.");
		}
		this.manaCost = manaCost;
		if ( levelNeeded.toMana() == 0 ) {
			throw new IllegalArgumentException("levelNeeded can not be 0.");
		}
	...
	public String toString() {
	    ...
	    String res = "[" + name + "(" + levelNeeded.toString() + "): " + manaCost + " mana";
